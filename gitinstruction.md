...
~~~
Далее перейти в локальный репозиторий и ввести git remote add origin `http://github/ВАШ РЕПОЗИТОРИЙ/Remote.git`. после этого произойдет привязка локального репозитория с удалённым.
